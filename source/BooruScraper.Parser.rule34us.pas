...
type
  ...
  TRule34usParser = Class(TBooruParser)
    public
      ...
      class function GetTagTypeByClass(AClass: string): TBooruTagType;
  End;
...
class function TRule34usParser.GetTagTypeByClass(AClass: string): TBooruTagType;
begin
...
class function TRule34usParser.ParsePostFromPage(
...
class function TRule34usParser.ParsePostsFromPage(
